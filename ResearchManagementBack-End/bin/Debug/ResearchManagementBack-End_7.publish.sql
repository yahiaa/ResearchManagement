...
GO
/*
The column Std_MajorId on table [dbo].[Students] must be changed from NULL to NOT NULL. If the table contains data, the ALTER script may not work. To avoid this issue, you must add values to this column for all rows or mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
ALTER TABLE [dbo].[Students] ALTER COLUMN [Std_MajorId] INT NOT NULL;
...
ALTER TABLE [dbo].[Students] WITH NOCHECK
    ADD FOREIGN KEY ([Std_MajorId]) REFERENCES [dbo].[Majors] ([Id]);
